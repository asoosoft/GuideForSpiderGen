...
<figure><img src="../../.gitbook/assets/image (6).png" alt=""><figcaption><p>chrom과 visual studio는 웹,윈도우 애플리케이션을 만들기 위해 필요한 것이므로 무시하여도 됩니다.</p></figcaption></figure>
...
관련 오류 발생시 `프로젝트이름\android\app\build.gradle.kts` 를 열어 아래와 같이 버전을 수정합니다.
