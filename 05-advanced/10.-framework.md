...
getUpdateValue(컴포넌트에 적용된 값을 속성창에 표현)



* AttrProp.js

<pre class="language-js"><code class="lang-js">// AttrProp에서 처리(컴포넌트 속성창에서 입력한 값을 컴포넌트에 적용)
...
applyValueToSelComp(selComp, dataKey, valGroup, value) {
    if (valGroup === 'ATTR_VALUE') {
        ...
        if (dataKey === 'data-aftertext') {
            ...
            selComp.setImage(selComp.getImage()); -> get 
            return;
        }
