...
<div align="left"><figure><img src="../.gitbook/assets/image (1) (1) (2).png" alt=""><figcaption></figcaption></figure> <figure><img src="../.gitbook/assets/스크린샷 2025-07-18 162823.png" alt=""><figcaption></figcaption></figure></div>
...
class AStatusBadge extends AComponent
{
    ...
    init(context, evtListener)
    {
        ...
        const savedStatus = this.element.getAttribute('data-status');
        if(savedStatus) {
    ...
    setStatus(status)
    {
        ...
        this.element.setAttribute('data-status', status || 'default');
    }
...
<div align="left"><figure><img src="../.gitbook/assets/image (2) (2) (1).png" alt=""><figcaption></figcaption></figure> <figure><img src="../.gitbook/assets/스크린샷 2025-07-15 133438.png" alt=""><figcaption></figcaption></figure></div>
