---
description: '## 스파이더젠 테마 변경 기능을 이용하여 손쉽게 어플리케이션 테마를 변경할 수 있습니다.'
---
...
* 프로젝트 폴더 내 Template 에 생성되어있는 Theme 폴더를 오른쪽 클릭하고 AddTheme를 클릭하여 사용할 테마를 생성합니다. (ex. black, white..., etc)

![](https://wikidocs.net/images/page/276201/%EC%82%AC%EC%A7%841.png)

* 위 사진과 같이 Theme 를 생성하였다면, Theme 폴더를 오른쪽 클릭한 후 Add new 를 눌러 Style 파일을 추가합니다. (ex. black\font\_style\_black.stl, white\font\_style\_white.stl)
